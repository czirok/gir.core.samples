...
{    
    public const string Library = "Notify";
    private const string WindowsLibraryName = "libnotify.so.4";
    private const string LinuxLibraryName = "libnotify.so.4";
    private const string OsxLibraryName = "libnotify.so.4";
